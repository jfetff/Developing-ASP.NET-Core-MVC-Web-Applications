...
- Instructions\20486_MOD04_DEMO.md
- Instructions\20486_MOD04_LAK.md

Entregar el url de GitHub con la solución y un readme con las siguiente información:

1. **Nombres y apellidos:** José René Fuentes Cortez
2. **Fecha:** 24 de Noviembre 2020.
3. **Resumen del Modulo 4:** Los ejercicios se dividen entre Laboratorios y MOC Demo que contienen ejercicios propios.
