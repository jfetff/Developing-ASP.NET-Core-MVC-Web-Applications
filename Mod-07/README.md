# Módulo 7: Usando Entity Framework Core del ASP.NET Core

Fichero de Instrucciones: 

- Instructions\20486D_MOD07_DEMO.md
- Instructions\20486D_MOD07_LAK.md

Entregar el url de GitHub con la solución y un readme con las siguiente información:

1. **Nombres y apellidos:** José René Fuentes Cortez
2. **Fecha:** 24 de Noviembre 2020.
3. **Resumen del Modulo 7:** Los ejercicios se dividen entre Laboratorios y MOC Demo que contienen ejercicios propios.
